...

{
  ...
  "pattern": [
{
  "regex": "^(Ano|ano|Sino|sino|Saan|saan|Kailan|kailan|Bakit|bakit|Papaano|papaano|paano|Paano)\\b.*?\\b(\\w+)\\b[^?!]$"
}
  ],
  ...
  "suggestions": [
    {
      "text": "$2?",
      "description": "Magdagdag ng tandang pananong sa huling salita '$2'."
    }
  ]
}
